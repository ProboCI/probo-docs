...
ga("create", "UA-4625819-6", "auto"), ga("send", "pageview"), function(e) {
    "function" == typeof define && define.amd ? define([ "jquery" ], e) : e(jQuery);
}(function(e) {
    function t(t, s) {
        var n, a, o, r = t.nodeName.toLowerCase();
        return "area" === r ? (n = t.parentNode, a = n.name, !(!t.href || !a || "map" !== n.nodeName.toLowerCase()) && (o = e("img[usemap='#" + a + "']")[0], 
        !!o && i(o))) : (/^(input|select|textarea|button|object)$/.test(r) ? !t.disabled : "a" === r ? t.href || s : s) && i(t);
    }
    function i(t) {
    ...
    e(document).mouseup(function() {
        ...
        _eventHandler: function(t) {
            ...
            t.preventDefault(), a && !i.collapsible || this._trigger("beforeActivate", t, l) === !1 || (i.active = !o && this.headers.index(n), 
    ...
    e.effects = {
        ...
        _mouseCapture: function(t) {
            ...
            this.handles.each(function(t) {
                ...
                a = e(this), o = t);
            }), r = this._start(t, o), r !== !1 && (this._mouseSliding = !0, this._handleIndex = o, 
        ...
        _mouseDrag: function(t) {
            ...
            a && s.instance === this.currentContainer && n !== this.currentItem[0] && this.placeholder[1 === a ? "next" : "prev"]()[0] !== n && !e.contains(this.placeholder[0], n) && ("semi-dynamic" !== this.options.type || !e.contains(this.element[0], n))) {
        ...
        _initialActive: function() {
            ...
            t !== !1 && (t = this.tabs.index(this.tabs.eq(t)), -1 === t && (t = !i && 0)), !i && t === !1 && this.anchors.length && (t = 0), 
            t;
        },
        _getCreateEventData: function() {
            return {
        ...
        _eventHandler: function(t) {
            ...
            t.preventDefault(), a.hasClass("ui-state-disabled") || a.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger("beforeActivate", t, u) === !1 || (i.active = !r && this.tabs.index(a), 
    ...
    var b = function(b, c, d) {
        return this.el = b, this.$el = a(b), this.options = c, this.uuid = this.$el.attr("id") ? this.$el.attr("id") : d, 
    ...
    b.prototype = {
        init: function() {
            ...
            b._load(), b.$el.find("ul").each(function(c) {
                var d = a(this);
                d.attr("data-index", c), b.options.save && b.state.hasOwnProperty(c) ? (d.parent().addClass(b.options.openClass), 
                d.show()) : d.parent().hasClass(b.options.openClass) ? (d.show(), b.state[c] = 1) : d.hide();
            });
        ...
        _trigger: function(b, c) {
            ...
            b.on("click", function(b) {
                ...
                if (e = e.length > 0 && e, d.options.onClickBefore.call(this, b, e), !c || e && f) b.preventDefault(), 
                d._toggle(e, e.is(":hidden")), d._save(); else if (d.options.accordion) {
        ...
        _toggle: function(b, c) {
            ...
            if (d.options.onToggleBefore.call(this, b, c), c) {
                if (f.addClass(d.options.openClass), b.slideDown(d.options.slide), d.state[e] = 1, 
                d.options.accordion) {
        ...
        if ("string" == typeof c && "_" !== c.charAt(0) && "init" !== c) var d = !0, e = Array.prototype.slice.call(arguments, 1); else c = a.extend({}, a.fn.navgoco.defaults, c || {}), 
        a.cookie || (c.save = !1);
        return this.each(function(f) {
            var g = a(this), h = g.data("navgoco");
            h || (h = new b(this, d ? a.fn.navgoco.defaults : c, f), g.data("navgoco", h)), 
            d && h[c].apply(h, e);
        });
    };
    var c = null;
...
}(jQuery), function(e, c, a, g) {
    function b(i, h) {
        this.element = i, this.$elem = e(this.element), this.options = e.extend({}, f, h), 
        this.init();
    }
    var d = "slimmenu", f = {
        resizeWidth: "768",
    ...
    b.prototype = {
        init: function() {
            var k, h = this.options, j = this.$elem, i = '<div class="menu-collapser">' + h.collapserTitle + '<div class="collapse-button"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></div></div>';
            j.before(i), k = j.prev(".menu-collapser"), j.on("click", ".sub-collapser", function(m) {
                m.preventDefault(), m.stopPropagation();
                var l = e(this).closest("li");
                e(this).hasClass("expanded") ? (e(this).removeClass("expanded"), e(this).find("i").html("&#9660;"), 
                l.find(">ul").slideUp(h.animSpeed, h.easingEffect)) : (e(this).addClass("expanded"), 
                e(this).find("i").html("&#9650;"), l.find(">ul").slideDown(h.animSpeed, h.easingEffect));
        ...
        resizeMenu: function(k) {
            ...
            }), h.resizeWidth >= l.width() ? (h.indentChildren && i.find("ul").each(function() {
                var m = e(this).parents("ul").length;
                e(this).children("li").children("a").has("i").length || e(this).children("li").children("a").prepend(b.prototype.indent(m, h));
            }), i.find("li").has("ul").off("mouseenter mouseleave"), i.addClass("collapsed").hide(), 
            j.show()) : (i.find("li").has("ul").on("mouseenter", function() {
        ...
        indent: function(k, j) {
            for (var h = "", l = 0; l < k; l++) h += j.childrenIndenter;
            return "<i>" + h + "</i>";
        }
    }, e.fn[d] = function(h) {
        return this.each(function() {
            e.data(this, "plugin_" + d) || e.data(this, "plugin_" + d, new b(this, h));
        });
    };
}(jQuery, window, document), !function(t, n, e, o) {
    "use strict";
    if (!n.history.pushState) return t.fn.smoothState = function() {
        return this;
    }, void (t.fn.smoothState.options = {});
    if (!t.fn.smoothState) {
        var r = t("html, body"), a = n.console, s = {
            debug: !1,
            anchors: "a",
            hrefRegex: "",
            forms: "form",
            ...
            isExternal: function(t) {
                var e = t.match(/^([^:\/?#]+:)?(?:\/\/([^\/?#]*))?([^?#]+)?(\?[^#]*)?(#.*)?/);
                return "string" == typeof e[1] && e[1].length > 0 && e[1].toLowerCase() !== n.location.protocol || "string" == typeof e[2] && e[2].length > 0 && e[2].replace(new RegExp(":(" + {
                    "http:": 80,
                    "https:": 443
            ...
            isHash: function(t, e) {
                e = e || n.location.href;
                var o = t.indexOf("#") > -1, r = i.stripHash(t) === i.stripHash(e);
                return o && r;
            },
            ...
            triggerAllAnimationEndEvent: function(n, e) {
                e = " " + e || "";
                var o = 0, r = "animationstart webkitAnimationStart oanimationstart MSAnimationStart", a = "animationend webkitAnimationEnd oanimationend MSAnimationEnd", s = "allanimationend", l = function(e) {
            ...
            if (null !== e.state) {
                var o = n.location.href, r = t("#" + e.state.id), a = r.data("smoothState");
                a.href === o || i.isHash(o, a.href) || a.load(o, !1);
            }
        }, u = function(s, l) {
            var u = t(s), c = u.prop("id"), f = null, h = !1, d = {}, p = n.location.href, g = function(t) {
                ...
                var s = "#" + c, i = d[o] ? t(d[o].html.html()) : null;
                i.length ? (e.title = d[o].title, u.data("smoothState").href = o, l.loadingClass && r.removeClass(l.loadingClass), 
                l.onReady.render(u, i), u.one("ss.onReadyEnd", function() {
                ...
                i.shouldLoadAnchor(o, l.blacklist, l.hrefRegex) && !h && (n.stopPropagation(), e = i.translate(o.prop("href")), 
                e = l.alterRequest(e), m(e));
            }, E = function(n) {
                var e = t(n.currentTarget);
                if (!n.metaKey && !n.ctrlKey && i.shouldLoadAnchor(e, l.blacklist, l.hrefRegex) && (n.stopPropagation(), 
                n.preventDefault(), !C())) {
                    T();
                ...
                if (!e.is(l.blacklist) && (n.preventDefault(), n.stopPropagation(), !C())) {
                    ...
                    h = !0, r = l.alterRequest(r), "get" === r.type.toLowerCase() && (r.url = r.url + "?" + r.data), 
                    l.onBefore(e, u), S(r, o, l.allowFormCaching);
                }
            }, P = 0, C = function() {
                var t = null === l.repeatDelay, n = parseInt(Date.now()) > P;
                return !(t || n);
            }, T = function() {
                P = parseInt(Date.now()) + parseInt(l.repeatDelay);
            }, A = function(t) {
                l.anchors && (t.on("click", l.anchors, E), l.prefetch && t.on(l.prefetchOn, l.anchors, w)), 
            ...
            return l = t.extend({}, t.fn.smoothState.options, l), null === n.history.state && n.history.replaceState({
                id: c
            }, e.title, p), i.storePageIn(d, p, e.documentElement.outerHTML, c), i.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), 
            A(u), {
                href: p,
                cache: d,
                clear: g,
    ...
    return Lightbox.defaults = {
        ...
        this.$lightbox.css({
            top: top + "px",
            left: left + "px"
        }).fadeIn(this.options.fadeDuration), this.options.disableScrolling && $("body").addClass("lb-disable-scrolling"), 
        ...
        preloader.onload = function() {
            ...
            windowHeight = $(window).height(), maxImageWidth = windowWidth - self.containerPadding.left - self.containerPadding.right - self.imageBorderWidth.left - self.imageBorderWidth.right - 20, 
        ...
        var self = this, oldWidth = this.$outerContainer.outerWidth(), oldHeight = this.$outerContainer.outerHeight(), newWidth = imageWidth + this.containerPadding.left + this.containerPadding.right + this.imageBorderWidth.left + this.imageBorderWidth.right, newHeight = imageHeight + this.containerPadding.top + this.containerPadding.bottom + this.imageBorderWidth.top + this.imageBorderWidth.bottom;
        ...
        if ("undefined" != typeof this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) {
            ...
            this.options.sanitizeTitle ? $caption.text(this.album[this.currentImageIndex].title) : $caption.html(this.album[this.currentImageIndex].title), 
    ...
    1: [ function(require, module, exports) {
        !function(window, undefined) {
            "use strict";
            var document = window.document, getByClass = require("./src/utils/get-by-class"), extend = require("./src/utils/extend"), indexOf = require("./src/utils/index-of"), events = require("./src/utils/events"), toString = require("./src/utils/to-string"), naturalSort = require("./src/utils/natural-sort"), classes = require("./src/utils/classes"), getAttribute = require("./src/utils/get-attribute"), toArray = require("./src/utils/to-array"), List = function(id, options, values) {
                var init, self = this, Item = require("./src/item")(self), addAsync = require("./src/add-async")(self);
                init = {
                    start: function() {
                        self.listClass = "list", self.searchClass = "search", self.sortClass = "sort", self.page = 1e4, 
                        self.i = 1, self.items = [], self.visibleItems = [], self.matchingItems = [], self.searched = !1, 
                        self.filtered = !1, self.searchColumns = undefined, self.handlers = {
                            updated: []
                        }, self.plugins = {}, self.valueNames = [], self.utils = {
                            ...
                            toArray: toArray
                        }, self.utils.extend(self, options), self.listContainer = "string" == typeof id ? document.getElementById(id) : id, 
                        self.listContainer && (self.list = getByClass(self.listContainer, self.listClass, !0), 
                        self.parse = require("./src/parse")(self), self.templater = require("./src/templater")(self), 
                        self.search = require("./src/search")(self), self.filter = require("./src/filter")(self), 
                        self.sort = require("./src/sort")(self), this.handlers(), this.items(), self.update(), 
                        this.plugins());
                    },
                    handlers: function() {
                        for (var handler in self.handlers) self[handler] && self.on(handler, self[handler]);
                    },
                    items: function() {
                        self.parse(self.list), values !== undefined && self.add(values);
                    },
                    plugins: function() {
                        for (var i = 0; i < self.plugins.length; i++) {
                            var plugin = self.plugins[i];
                            self[plugin.name] = plugin, plugin.init(self, List);
                        }
                    }
                }, this.reIndex = function() {
                    self.items = [], self.visibleItems = [], self.matchingItems = [], self.searched = !1, 
                    self.filtered = !1, self.parse(self.list);
                }, this.toJSON = function() {
                    for (var json = [], i = 0, il = self.items.length; i < il; i++) json.push(self.items[i].values());
                    return json;
                }, this.add = function(values, callback) {
                    if (0 !== values.length) {
                        if (callback) return void addAsync(values, callback);
                        var added = [], notCreate = !1;
                        values[0] === undefined && (values = [ values ]);
                        for (var i = 0, il = values.length; i < il; i++) {
                            var item = null;
                            notCreate = self.items.length > self.page, item = new Item(values[i], undefined, notCreate), 
                            self.items.push(item), added.push(item);
                        }
                        return self.update(), added;
                    }
                }, this.show = function(i, page) {
                    return this.i = i, this.page = page, self.update(), self;
                }, this.remove = function(valueName, value, options) {
                    for (var found = 0, i = 0, il = self.items.length; i < il; i++) self.items[i].values()[valueName] == value && (self.templater.remove(self.items[i], options), 
                    self.items.splice(i, 1), il--, i--, found++);
                    return self.update(), found;
                }, this.get = function(valueName, value) {
                    for (var matchedItems = [], i = 0, il = self.items.length; i < il; i++) {
                        var item = self.items[i];
                        item.values()[valueName] == value && matchedItems.push(item);
                    }
                    return matchedItems;
                }, this.size = function() {
                    return self.items.length;
                }, this.clear = function() {
                    return self.templater.clear(), self.items = [], self;
                }, this.on = function(event, callback) {
                    return self.handlers[event].push(callback), self;
                }, this.off = function(event, callback) {
                    var e = self.handlers[event], index = indexOf(e, callback);
                    return index > -1 && e.splice(index, 1), self;
                }, this.trigger = function(event) {
                    for (var i = self.handlers[event].length; i--; ) self.handlers[event][i](self);
                    return self;
                }, this.reset = {
                    filter: function() {
                        for (var is = self.items, il = is.length; il--; ) is[il].filtered = !1;
                        return self;
                    },
                    search: function() {
                        for (var is = self.items, il = is.length; il--; ) is[il].found = !1;
                        return self;
                    }
                }, this.update = function() {
                    var is = self.items, il = is.length;
                    self.visibleItems = [], self.matchingItems = [], self.templater.clear();
                    for (var i = 0; i < il; i++) is[i].matching() && self.matchingItems.length + 1 >= self.i && self.visibleItems.length < self.page ? (is[i].show(), 
                    self.visibleItems.push(is[i]), self.matchingItems.push(is[i])) : is[i].matching() ? (self.matchingItems.push(is[i]), 
                    is[i].hide()) : is[i].hide();
                    return self.trigger("updated"), self;
                }, init.start();
            };
            "function" == typeof define && define.amd && define(function() {
                return List;
            }), module.exports = List, window.List = List;
        }(window);
    }, {
        "./src/add-async": 2,
        "./src/filter": 3,
    ...
    2: [ function(require, module, exports) {
        module.exports = function(list) {
            var addAsync = function(values, callback, items) {
                ...
                items = items || [], items = items.concat(list.add(valuesToAdd)), values.length > 0 ? setTimeout(function() {
                    addAsync(values, callback, items);
                }, 1) : (list.update(), callback(items));
            };
            return addAsync;
        };
    }, {} ],
    3: [ function(require, module, exports) {
        module.exports = function(list) {
            return list.handlers.filterStart = list.handlers.filterStart || [], list.handlers.filterComplete = list.handlers.filterComplete || [], 
            function(filterFunction) {
                if (list.trigger("filterStart"), list.i = 1, list.reset.filter(), void 0 === filterFunction) list.filtered = !1; else {
                    list.filtered = !0;
                    for (var is = list.items, i = 0, il = is.length; i < il; i++) {
                        var item = is[i];
                        filterFunction(item) ? item.filtered = !0 : item.filtered = !1;
                    }
                }
                return list.update(), list.trigger("filterComplete"), list.visibleItems;
            };
        };
    }, {} ],
        ...
        module.exports = function(list) {
            return function(initValues, element, notCreate) {
                ...
                var init = function(initValues, element, notCreate) {
                    if (void 0 === element) notCreate ? item.values(initValues, notCreate) : item.values(initValues); else {
                        item.elm = element;
                ...
                this.values = function(newValues, notCreate) {
                    if (void 0 === newValues) return item._values;
                    for (var name in newValues) item._values[name] = newValues[name];
                    notCreate !== !0 && list.templater.set(item, item.values());
                }, this.show = function() {
    ...
    5: [ function(require, module, exports) {
        module.exports = function(list) {
            var Item = require("./item")(list), getChildren = function(parent) {
                for (var nodes = parent.childNodes, items = [], i = 0, il = nodes.length; i < il; i++) void 0 === nodes[i].data && items.push(nodes[i]);
                return items;
            }, parse = function(itemElements, valueNames) {
                for (var i = 0, il = itemElements.length; i < il; i++) list.items.push(new Item(valueNames, itemElements[i]));
            }, parseAsync = function(itemElements, valueNames) {
                var itemsToIndex = itemElements.splice(0, 50);
                parse(itemsToIndex, valueNames), itemElements.length > 0 ? setTimeout(function() {
                    parseAsync(itemElements, valueNames);
                }, 1) : (list.update(), list.trigger("parseComplete"));
            };
            return list.handlers.parseComplete = list.handlers.parseComplete || [], function() {
                var itemsToIndex = getChildren(list.list), valueNames = list.valueNames;
                list.indexAsync ? parseAsync(itemsToIndex, valueNames) : parse(itemsToIndex, valueNames);
            };
        };
    }, {
        "./item": 4
    ...
    6: [ function(require, module, exports) {
        module.exports = function(list) {
            var text, columns, searchString, customSearch, prepare = {
                resetList: function() {
                    list.i = 1, list.templater.clear(), customSearch = void 0;
                },
                setOptions: function(args) {
                    2 == args.length && args[1] instanceof Array ? columns = args[1] : 2 == args.length && "function" == typeof args[1] ? customSearch = args[1] : 3 == args.length && (columns = args[1], 
                    customSearch = args[2]);
                },
                setColumns: function() {
                    0 !== list.items.length && void 0 === columns && (columns = void 0 === list.searchColumns ? prepare.toArray(list.items[0].values()) : list.searchColumns);
                },
                setSearchString: function(s) {
                    s = list.utils.toString(s).toLowerCase(), s = s.replace(/[-[\]{}()*+?.,\\^$|#]/g, "\\$&"), 
                    searchString = s;
                },
                ...
                list: function() {
                    for (var k = 0, kl = list.items.length; k < kl; k++) search.item(list.items[k]);
                },
                item: function(item) {
                    item.found = !1;
                    for (var j = 0, jl = columns.length; j < jl; j++) if (search.values(item.values(), columns[j])) return void (item.found = !0);
                },
                values: function(values, column) {
                    return !!(values.hasOwnProperty(column) && (text = list.utils.toString(values[column]).toLowerCase(), 
                    "" !== searchString && text.search(searchString) > -1));
                },
                reset: function() {
                    list.reset.search(), list.searched = !1;
                }
            }, searchMethod = function(str) {
                return list.trigger("searchStart"), prepare.resetList(), prepare.setSearchString(str), 
                prepare.setOptions(arguments), prepare.setColumns(), "" === searchString ? search.reset() : (list.searched = !0, 
                customSearch ? customSearch(searchString, columns) : search.list()), list.update(), 
                list.trigger("searchComplete"), list.visibleItems;
            };
            return list.handlers.searchStart = list.handlers.searchStart || [], list.handlers.searchComplete = list.handlers.searchComplete || [], 
            list.utils.events.bind(list.utils.getByClass(list.listContainer, list.searchClass), "keyup", function(e) {
                var target = e.target || e.srcElement, alreadyCleared = "" === target.value && !list.searched;
                alreadyCleared || searchMethod(target.value);
            }), list.utils.events.bind(list.utils.getByClass(list.listContainer, list.searchClass), "input", function(e) {
                var target = e.target || e.srcElement;
                "" === target.value && searchMethod("");
            }), searchMethod;
        };
    }, {} ],
    7: [ function(require, module, exports) {
        module.exports = function(list) {
            list.sortFunction = list.sortFunction || function(itemA, itemB, options) {
                return options.desc = "desc" == options.order, list.utils.naturalSort(itemA.values()[options.valueName], itemB.values()[options.valueName], options);
            };
            var buttons = {
                els: void 0,
                clear: function() {
                    for (var i = 0, il = buttons.els.length; i < il; i++) list.utils.classes(buttons.els[i]).remove("asc"), 
                    list.utils.classes(buttons.els[i]).remove("desc");
                },
                getOrder: function(btn) {
                    var predefinedOrder = list.utils.getAttribute(btn, "data-order");
                    return "asc" == predefinedOrder || "desc" == predefinedOrder ? predefinedOrder : list.utils.classes(btn).has("desc") ? "asc" : list.utils.classes(btn).has("asc") ? "desc" : "asc";
                },
                getInSensitive: function(btn, options) {
                    var insensitive = list.utils.getAttribute(btn, "data-insensitive");
                    "false" === insensitive ? options.insensitive = !1 : options.insensitive = !0;
                },
                setOrder: function(options) {
                    for (var i = 0, il = buttons.els.length; i < il; i++) {
                        ...
                        if (list.utils.getAttribute(btn, "data-sort") === options.valueName) {
                            var predefinedOrder = list.utils.getAttribute(btn, "data-order");
                            "asc" == predefinedOrder || "desc" == predefinedOrder ? predefinedOrder == options.order && list.utils.classes(btn).add(options.order) : list.utils.classes(btn).add(options.order);
                        }
                    }
                }
            }, sort = function() {
                ...
                target ? (options.valueName = list.utils.getAttribute(target, "data-sort"), buttons.getInSensitive(target, options), 
                options.order = buttons.getOrder(target)) : (options = arguments[1] || options, 
                options.valueName = arguments[0], options.order = options.order || "asc", options.insensitive = "undefined" == typeof options.insensitive || options.insensitive), 
                buttons.clear(), buttons.setOrder(options), options.sortFunction = options.sortFunction || list.sortFunction, 
                list.items.sort(function(a, b) {
                    var mult = "desc" === options.order ? -1 : 1;
                    return options.sortFunction(a, b, options) * mult;
                }), list.update(), list.trigger("sortComplete");
            };
            return list.handlers.sortStart = list.handlers.sortStart || [], list.handlers.sortComplete = list.handlers.sortComplete || [], 
            buttons.els = list.utils.getByClass(list.listContainer, list.sortClass), list.utils.events.bind(buttons.els, "click", sort), 
            list.on("searchStart", buttons.clear), list.on("filterStart", buttons.clear), sort;
        };
    }, {} ],
    8: [ function(require, module, exports) {
        var Templater = function(list) {
            var itemSource, templater = this, init = function() {
                itemSource = templater.getItemSource(list.item), itemSource = templater.clearSourceItem(itemSource, list.valueNames);
            };
            this.clearSourceItem = function(el, valueNames) {
                for (var i = 0, il = valueNames.length; i < il; i++) {
                    var elm;
                    if (valueNames[i].data) for (var j = 0, jl = valueNames[i].data.length; j < jl; j++) el.setAttribute("data-" + valueNames[i].data[j], ""); else valueNames[i].attr && valueNames[i].name ? (elm = list.utils.getByClass(el, valueNames[i].name, !0), 
                    elm && elm.setAttribute(valueNames[i].attr, "")) : (elm = list.utils.getByClass(el, valueNames[i], !0), 
                    elm && (elm.innerHTML = ""));
                    elm = void 0;
                }
                return el;
                ...
                if (void 0 === item) {
                    for (var nodes = list.list.childNodes, i = 0, il = nodes.length; i < il; i++) if (void 0 === nodes[i].data) return nodes[i].cloneNode(!0);
                } else {
                    if (/^tr[\s>]/.exec(item)) {
                    ...
                    if (item.indexOf("<") !== -1) {
                        ...
                        return div.innerHTML = item, div.firstChild;
                    }
                ...
                for (var values = {}, i = 0, il = valueNames.length; i < il; i++) {
                    var elm;
                    if (valueNames[i].data) for (var j = 0, jl = valueNames[i].data.length; j < jl; j++) values[valueNames[i].data[j]] = list.utils.getAttribute(item.elm, "data-" + valueNames[i].data[j]); else valueNames[i].attr && valueNames[i].name ? (elm = list.utils.getByClass(item.elm, valueNames[i].name, !0), 
                    values[valueNames[i].name] = elm ? list.utils.getAttribute(elm, valueNames[i].attr) : "") : (elm = list.utils.getByClass(item.elm, valueNames[i], !0), 
                ...
                var getValueName = function(name) {
                    for (var i = 0, il = list.valueNames.length; i < il; i++) if (list.valueNames[i].data) {
                        for (var data = list.valueNames[i].data, j = 0, jl = data.length; j < jl; j++) if (data[j] === name) return {
                            data: name
                        };
                    } else {
                        if (list.valueNames[i].attr && list.valueNames[i].name && list.valueNames[i].name == name) return list.valueNames[i];
                        if (list.valueNames[i] === name) return name;
                    }
                }, setValue = function(name, value) {
                    var elm, valueName = getValueName(name);
                    valueName && (valueName.data ? item.elm.setAttribute("data-" + valueName.data, value) : valueName.attr && valueName.name ? (elm = list.utils.getByClass(item.elm, valueName.name, !0), 
                    elm && elm.setAttribute(valueName.attr, value)) : (elm = list.utils.getByClass(item.elm, valueName, !0), 
                    elm && (elm.innerHTML = value)), elm = void 0);
                };
                if (!templater.create(item)) for (var v in values) values.hasOwnProperty(v) && setValue(v, values[v]);
            }, this.create = function(item) {
                if (void 0 !== item.elm) return !1;
                var newItem = itemSource.cloneNode(!0);
                return newItem.removeAttribute("id"), item.elm = newItem, templater.set(item, item.values()), 
                !0;
            }, this.remove = function(item) {
                item.elm.parentNode === list.list && list.list.removeChild(item.elm);
            }, this.show = function(item) {
                templater.create(item), list.list.appendChild(item.elm);
            }, this.hide = function(item) {
                void 0 !== item.elm && item.elm.parentNode === list.list && list.list.removeChild(item.elm);
            }, this.clear = function() {
                if (list.list.hasChildNodes()) for (;list.list.childNodes.length >= 1; ) list.list.removeChild(list.list.firstChild);
            }, init();
        };
        module.exports = function(list) {
    ...
    9: [ function(require, module, exports) {
        ...
        var index = require("./index-of"), re = /\s+/, toString = Object.prototype.toString;
        module.exports = function(el) {
            return new ClassList(el);
        }, ClassList.prototype.add = function(name) {
            if (this.list) return this.list.add(name), this;
            var arr = this.array(), i = index(arr, name);
            return ~i || arr.push(name), this.el.className = arr.join(" "), this;
            ...
            var arr = this.array(), i = index(arr, name);
            return ~i && arr.splice(i, 1), this.el.className = arr.join(" "), this;
        }, ClassList.prototype.removeMatching = function(re) {
            for (var arr = this.array(), i = 0; i < arr.length; i++) re.test(arr[i]) && this.remove(arr[i]);
            return this;
        }, ClassList.prototype.toggle = function(name, force) {
            return this.list ? ("undefined" != typeof force ? force !== this.list.toggle(name, force) && this.list.toggle(name) : this.list.toggle(name), 
            this) : ("undefined" != typeof force ? force ? this.add(name) : this.remove(name) : this.has(name) ? this.remove(name) : this.add(name), 
            this);
        }, ClassList.prototype.array = function() {
            var className = this.el.getAttribute("class") || "", str = className.replace(/^\s+|\s+$/g, ""), arr = str.split(re);
    ...
    10: [ function(require, module, exports) {
        var bind = window.addEventListener ? "addEventListener" : "attachEvent", unbind = window.removeEventListener ? "removeEventListener" : "detachEvent", prefix = "addEventListener" !== bind ? "on" : "", toArray = require("./to-array");
        exports.bind = function(el, type, fn, capture) {
            el = toArray(el);
            for (var i = 0; i < el.length; i++) el[i][bind](prefix + type, fn, capture || !1);
        }, exports.unbind = function(el, type, fn, capture) {
            el = toArray(el);
            for (var i = 0; i < el.length; i++) el[i][unbind](prefix + type, fn, capture || !1);
        };
    }, {
        "./to-array": 16
    } ],
    11: [ function(require, module, exports) {
        module.exports = function(object) {
            for (var source, args = Array.prototype.slice.call(arguments, 1), i = 0; source = args[i]; i++) if (source) for (var property in source) object[property] = source[property];
            return object;
        };
    }, {} ],
    12: [ function(require, module, exports) {
        module.exports = function(el, attr) {
            ...
            if (!result) for (var attrs = el.attributes, length = attrs.length, i = 0; i < length; i++) void 0 !== attr[i] && attr[i].nodeName === attr && (result = attr[i].nodeValue);
            return result;
        };
    }, {} ],
    13: [ function(require, module, exports) {
        module.exports = function() {
            return document.getElementsByClassName ? function(container, className, single) {
                return single ? container.getElementsByClassName(className)[0] : container.getElementsByClassName(className);
            } : document.querySelector ? function(container, className, single) {
                return className = "." + className, single ? container.querySelector(className) : container.querySelectorAll(className);
            } : function(container, className, single) {
                var classElements = [], tag = "*";
                null === container && (container = document);
                for (var els = container.getElementsByTagName(tag), elsLen = els.length, pattern = new RegExp("(^|\\s)" + className + "(\\s|$)"), i = 0, j = 0; i < elsLen; i++) if (pattern.test(els[i].className)) {
    ...
    15: [ function(require, module, exports) {
        module.exports = function(a, b, opts) {
            var oFxNcL, oFyNcL, re = /(^([+\-]?(?:\d*)(?:\.\d*)?(?:[eE][+\-]?\d+)?)?$|^0x[\da-fA-F]+$|\d+)/g, sre = /^\s+|\s+$/g, snre = /\s+/g, dre = /(^([\w ]+,?[\w ]+)?[\w ]+,?[\w ]+\d+:\d+(:\d+)?[\w ]?|^\d{1,4}[\/\-]\d{1,4}[\/\-]\d{1,4}|^\w+, \w+ \d+, \d{4})/, hre = /^0x[0-9a-f]+$/i, ore = /^0/, options = opts || {}, i = function(s) {
                return options.insensitive && ("" + s).toLowerCase() || "" + s;
            }, x = i(a) || "", y = i(b) || "", xN = x.replace(re, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"), yN = y.replace(re, "\0$1\0").replace(/\0$/, "").replace(/^\0/, "").split("\0"), xD = parseInt(x.match(hre), 16) || 1 !== xN.length && Date.parse(x), yD = parseInt(y.match(hre), 16) || xD && y.match(dre) && Date.parse(y) || null, normChunk = function(s, l) {
            ...
            for (var cLoc = 0, xNl = xN.length, yNl = yN.length, numS = Math.max(xNl, yNl); cLoc < numS; cLoc++) {
                if (oFxNcL = normChunk(xN[cLoc], xNl), oFyNcL = normChunk(yN[cLoc], yNl), isNaN(oFxNcL) !== isNaN(oFyNcL)) return isNaN(oFxNcL) ? 1 : -1;
                if (typeof oFxNcL != typeof oFyNcL && (oFxNcL += "", oFyNcL += ""), oFxNcL < oFyNcL) return -1;
    ...
    16: [ function(require, module, exports) {
        ...
        module.exports = function(collection) {
            if ("undefined" == typeof collection) return [];
    ...
    17: [ function(require, module, exports) {
        module.exports = function(s) {
            return s = void 0 === s ? "" : s, s = null === s ? "" : s, s = s.toString();
        };
    }, {} ]
    ...
    var featureName, hasOwnProp, version = "2.8.3", Modernizr = {}, enableClasses = !0, docElement = document.documentElement, mod = "modernizr", modElem = document.createElement(mod), mStyle = modElem.style, inputElem = document.createElement("input"), smile = ":)", prefixes = ({}.toString, 
    " -webkit- -moz- -o- -ms- ".split(" ")), ns = {
        svg: "http://www.w3.org/2000/svg"
    }, tests = {}, inputs = {}, classes = [], slice = classes.slice, injectElementWithStyles = function(rule, callback, nodes, testnames) {
    ...
    Modernizr.mq = testMediaQuery, Modernizr.testStyles = injectElementWithStyles, docElement.className = docElement.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (enableClasses ? " js " + classes.join(" ") : ""), 
    Modernizr;
    ...
    $.fn.tinyNav = function(options) {
        ...
        return this.each(function() {
            i++;
            var $nav = $(this), namespace = "tinynav", namespace_i = namespace + i, l_namespace_i = ".l_" + namespace_i, $select = $("<select/>").attr("id", namespace_i).addClass(namespace + " " + namespace_i);
            if ($nav.is("ul,ol")) {
                ...
                }), $select.append(options), settings.header || $select.find(":eq(" + $(l_namespace_i + " li").index($(l_namespace_i + " li." + settings.active)) + ")").attr("selected", !0), 
